...
// .toLowerCase method - returns a NEW string with all characters uppercase
console.log(fullName);
...
/* Template Literals (the formatted string(f-string) for JS) We use backticks (`) to declare a string and then we can use 
...
// We can have multiple variables on one string
...
var attrOne = `smart`
var attrTwo = `wise`
var attrThree = 'easeful'


var bestFriend = `My best friend is ${attrOne}, ${attrTwo} and ${attrThree}.`;
...
console.log(typeof fullName); //returns "string
...
var someInt = 123;
console.log(someInt);
console.log(typeof someInt); // returns number

var someFloat = 3.14;
console.log(someFloat);
console.log(typeof someFloat); //returns number 
...
console.log(added);
console.log(typeof added); // return '123456' as string

// similar to the int() and str() function in Pyhton, JS has parseInt(), parseFloat(), Number(), Number.tostring()
...
console.log(num1A);
console.log(typeof num1A); // number
...
console.log(num2A);
console.log(typeof num2A); // returns 987 as number

var num2B = parseFloat(num2);
console.log(num2B);
console.log(typeof num2B); // returns 987.65 as number
...
console.log(num3A);
console.log(typeof num3A); // returns  4983 as a number
...
console.log(notANumA); // returns NaN which means not a number
...
var quiz3 = 10 > '9'
console.log(quiz3) // True bc it auto converts 9 to a number
...
console.log(numOne == strOne); // true because same value

console.log(numOne === strOne); // false because different types
...
console.log(numOne != strOne); // false because same value, different data type

console.log(numOne !== strOne); // true bc diff data type
...
// if/else
//if(conditoin){code to run if true} else{code to run if false}
